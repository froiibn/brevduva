...
| 2026-09-14 | 릴리스·배포 (brv 0.7.3) | 완료 | 공개 `b469835`·서버 `1865bae`, 두 CI 녹색(서버 CI 1회 일시 실패 재실행) → publish(v0.7.3) → deploy. 내용: 서비스 파일 비켜 두기 고유 이름(P8 ⑨), 옛 중계기 자동 종료(P8 ⑩), Codex 통로 measured. 작업 규칙 10(지시 없이 리시버·옛 프로세스 손대지 않음) 등재 |
